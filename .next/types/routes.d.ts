...
type AppRouteHandlerRoutes = "/api/appointments" | "/api/appointments/[id]" | "/api/appointments/day" | "/api/auth/change-password" | "/api/auth/login" | "/api/auth/logout" | "/api/calendar" | "/api/departments" | "/api/discounts" | "/api/doctors" | "/api/doctors/[id]" | "/api/doctors/[id]/availability" | "/api/invoices" | "/api/invoices/[id]" | "/api/miniapp/book" | "/api/miniapp/doctors" | "/api/miniapp/hold" | "/api/patients" | "/api/services" | "/api/statistics" | "/api/stats" | "/api/users" | "/api/users/[id]" | "/kassir/[id]/cancel" | "/kassir/[id]/pay"
